...
const InputBar: React.FC<Props> = ({
  ...
  return (
    <form onSubmit={onSubmit} className="sm:p-4 px-1 py-4 bg-white relative">
  ...
  <button
    ...
    className="p-2 sm:block hidden rounded-full text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200"
  >
  ...
  <button
    type="submit"
    title="Send"
    className="ml-auto bg-gradient-to-r  cursor-pointer from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-full p-3 shadow-md transition-all duration-200 group"
  >
